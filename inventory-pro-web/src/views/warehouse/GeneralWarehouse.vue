        ...
        <div class="flex-1 min-w-[300px]">
          <div class="relative">
            ...
            <input 
              ...
              class="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl focus:outline-none focus:border-blue-500"
            />
          </div>
        </div>
